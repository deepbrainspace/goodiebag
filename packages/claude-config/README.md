...
Complete Claude Code configuration package with global settings, character personalities, and MCP server automation for enhanced development workflows.
...
- **[mcp-env.template](./templates/mcp-env.template)** - Environment variables template
- **[mcp-commands.md](./templates/mcp-commands.md)** - Copy-paste command reference
- **[api-keys-checklist.md](./templates/api-keys-checklist.md)** - API key acquisition guide
...
**Complete Installation Guide:** See [INSTALLATION.md](./docs/INSTALLATION.md) for detailed platform-specific instructions.
...
**Complete MCP Guide:** See [MCP_SETUP.md](./docs/MCP_SETUP.md) for API keys, troubleshooting, and detailed setup.
...
- Customizable via editing `~/.claude/` files
...
This configuration package is part of the Goodiebag monorepo. See repository license for details.
