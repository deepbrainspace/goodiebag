...
- after merging, switch to the main branch and pull it in so its updated with the change that was merged.
- when starting new work, create a new branch from the main branch, UNLESS a branch has already been
created and you are in that branch.
